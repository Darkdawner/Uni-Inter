...
class Chi3dData():
    def __init__(self, cfg, mode):
        ...
        self.human1_motion_data_path = os.path.join(data_root, f'chi3d/{split}/person1/')
        self.human2_motion_data_path = os.path.join(data_root, f'chi3d/{split}/person2/')
        self.human1_motion_smpl_data_path = os.path.join(data_root, f'chi3d/{split}/person1_smplx/')
        self.human2_motion_smpl_data_path = os.path.join(data_root, f'chi3d/{split}/person2_smplx/')
    ...
    def get_data_by_name(self, name, start_frame, augment=False):
        ...
        floor_height = human1_smpl_motion.min(1).min(0)[1]
        human1_smpl_motion[:, :, 1] -= floor_height
        floor_height = human2_smpl_motion.min(1).min(0)[1]
        human2_smpl_motion[:, :, 1] -= floor_height
